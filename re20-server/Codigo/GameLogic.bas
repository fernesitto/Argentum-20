...
Sub LookatTile(ByVal UserIndex As Integer, ByVal map As Integer, ByVal x As Integer, ByVal y As Integer)
        ...
        Dim status As String 'status faccion
...
366                         'Stat = "Ves a " & UserList(TempCharIndex).name & Stat & " - " & UserList(TempCharIndex).Desc
                            Stat = UserList(TempCharIndex).name & "(" & DameClase(UserList(TempCharIndex).CLASE) & " " & DameRaza(UserList(TempCharIndex).raza) & ", Nivel " & UserList(TempCharIndex).Stats.ELV & ")" & " " & status & " " & Stat & " - " & UserList(TempCharIndex).Desc
                        Else
368                         Stat = UserList(TempCharIndex).name & "(" & DameClase(UserList(TempCharIndex).CLASE) & " " & DameRaza(UserList(TempCharIndex).raza) & " | Nivel " & UserList(TempCharIndex).Stats.ELV & ")" & " " & status & " " & Stat
                        End If
...
End Sub
Public Function DameClase(ByVal CLASE As e_Class) As String
    ...
    Select Case CLASE
        ...
        End Select
End Function
Public Function DameRaza(ByVal raza As e_Raza) As String
    Select Case raza
        Case 1
            DameRaza = "Humano"
        Case 2
