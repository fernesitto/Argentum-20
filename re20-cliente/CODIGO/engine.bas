...
Private Sub Renderizar_Aura(ByVal aura_index As String, ByVal x As Integer, ByVal y As Integer, ByVal map_x As Byte, ByVal map_y As Byte, Optional ByVal userIndex As Long = 0)
    ...
    'Dim pos1 As Integer
    'pos1 = InStr(aura_index, ":")
    
   ' Dim pos2 As Integer
   ' pos2 = InStr(pos1 + 1, aura_index, ":")
    
    'Cadena = mid(aura_index, 1, pos1 - 1)
    Cadena = ReadField(1, aura_index, Asc(":"))
    Index = Val(Cadena)
    'cadena2 = mid(aura_index, pos1 + 1, pos2 - pos1 - 1)
    cadena2 = ReadField(2, aura_index, Asc(":"))
    ...
    Dim r, B, G, red, blue, green As Byte
    ...
    Call RGBAList(rgb_list, red, green, blue)
    'Call Long_2_RGBAList(rgb_list, cadena2)

    'Convertimos el Aura en un GRH
    aura_grh.GrhIndex = Index
